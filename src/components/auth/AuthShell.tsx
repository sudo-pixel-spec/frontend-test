...
export default function AuthShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex items-center justify-center text-white overflow-hidden bg-transparent">
      <div className="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(circle_at_25%_20%,rgba(56,189,248,0.06),transparent_50%),radial-gradient(circle_at_75%_75%,rgba(249,115,22,0.04),transparent_50%)]" />
